      ...
      <div class="container hero-layout">
        <div class="hero-copy">
          ...
          <div class="hero-identity">
            ...
            <a class="hero-identity__phone" href="tel:+14253800511">(425) 380-0511</a>
          </div>
          <div class="hero-buttons"><a class="btn btn-primary" href="tel:+14253800511">Call (425) 380-0511</a><a class="btn btn-outline" href="#estimate">Request an estimate</a></div>
        </div>
        {drawing}
      </div>
    </section>'''
...
def estimate_section() -> str:
    return '''<section id="estimate" class="estimate-section"><div class="container estimate-shell"><div><h2>Start with a clear scope</h2><p>Tell us what must change, where the property is, and what you need priced. We will identify the next useful step.</p><p><strong>Prefer to talk through it?</strong> Call <a href="tel:+14253800511">(425) 380-0511</a>.</p><p>Before comparing proposals, <a href="/about.html#project-planning">prepare your Everett and Snohomish County planning worksheet</a>.</p></div>
